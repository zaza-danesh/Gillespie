...
#include "4CGillespieDiffusion.h"
#include <stdio.h>
#include <iostream.h>
#include <vector>
#include <cmath>
...
#define V 8
#define nMax 80
#define M 4 //number of compartments
using namespace std;
#include "st.h"
//#include "aleatoire.h"
//#include "etime.h"
...
int main(){
    ...
    int k= 1;
    //    int nstep=0;
    long int n1=20, n2=20, n3=20, n4=20;
    double k1=.2;
    double k2=1.75;
    double kD=1;
    double lambda = 1;
    ...
    double C, C4, iC4;
    double d12, d21, d23, d32, d34, d43, p11, p12, p21, p22, p31, p32, p41,p42;
...
//    sprintf(filename, "4CData.dat");
    ...
    while (t<fT){
        ...
        sump = d12 + d21 + d23 + d32 +d34 + d43 + p11 + p12 + p21 + p22 + p31 + p32 + p41 + p42;
        ...
        if(n1 + n2 + n3 + n4  <M*nMax){p[n1+n2+n3+n4]=p[n1+n2+ n3+n4]+tau;}
